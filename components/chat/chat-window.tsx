...
export function ChatWindow({ 
  ...
  // Double message hamesha ke liye filter
  ...
  return (
    <div className="h-full flex flex-col bg-[#0b141a] relative border-l border-[#222e35] w-full font-sans">
      ...
      <div className="flex-1 overflow-y-auto p-4 relative custom-scrollbar" style={{ backgroundColor: '#0b141a' }}>
        ...
        <div className="relative z-10 space-y-2">
          {uniqueMessages.map((msg: any, index: number) => {
            ...
            // 🚀 HY BUG FIX: Agar Optimistic (Naya bheja hua) hai, toh hamesha RIGHT SIDE (isOwn = true) force karo!
      ...
      <form onSubmit={handleSend} className="p-3 bg-[#202c33] flex items-center gap-2 z-20">
        <input value={input} onChange={(e) => setInput(e.target.value)} placeholder="Message" className="flex-1 bg-[#2a3942] text-[#e9edef] placeholder-[#8696a0] rounded-lg px-4 py-3 text-[15px] focus:outline-none" />
